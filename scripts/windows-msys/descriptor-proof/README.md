...
- 11 parser tests, including missing drain, missing object, wrong-profile success, absent effective descriptor check, duplicate object, noncanonical base64 and absent final effects. Run them with `node --test scripts/windows-msys/descriptor-proof/parser.test.cjs`.
