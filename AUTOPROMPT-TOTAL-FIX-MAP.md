...
> **LOCAL-ONLY SAFETY RULE:** this document and every change made from it stay on the local sub-branch. Never push, publish, open a pull request, create a release, or use a GitHub write API. The current branch still tracks `origin/main`, so no commit is allowed until implementation installs and tests a fail-closed local no-push guard and removes the upstream association. After that guard exists, narrow local checkpoint commits are allowed for recovery, but remote writes remain forbidden.
...
The current local Codex artifact binding is FINAL-6: package version `1.0.9`; generation `codex-v2.0.0-576e13a743a0a74e`; payload `576e13a743a0a74e7916b69b6ab184058c641f1c60e77bb3092a62fb6e8175e3`; closure `a470242feb99ef2a9fc955e2d5a2037c8fde603442475cf541ff0f0188751115`; manifest `9064f190b2195eb994c9fddcf55b2e374bc260f30728d679f81117ff98757f6a`; identity `071c9375c8085446c7c7f70cb49b9db3fbb51ddced58c183e5cd12a803e50415`; package `384e8a22b7e18cfcab5e1bac0cd33cf12bd550a24530cca8016783f361b658e2`; registry `f6093514e69a7516265151d55147f5541c8380b5f8b6d2515f2d52f842455446`; release `770913fcafe9e73fceda7bcfe87a27db665da40dafb7c90e1e329def59ce7cfe`; history `a1c085ba976c82d606840e62624fe610284930a949d517a08a487289f9c8efff`; history head `71f703ec61b16ad273c4895c2631bf7bcd863b7a9d17cd5fa16692dcc33fc069`. The canonical public live-conformance evidence remains FAIL/null at SHA-256 `142d7f6c34fae8328a71ba816456aa8f9b31633d11588fe560d7ffe5509ff63e`, with raw lineage SHA-256 `2e24eda37043240b3cf3a008e6a3c628d87653741b21e38d4947d54955e01c59`; no PASS or external-verification claim is inferred from the local artifact binding.
