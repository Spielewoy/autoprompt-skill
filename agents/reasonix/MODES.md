...
### Reasonix agent selection and effort

Reasonix casting is `inherited-only`: native manual `runAs: subagent` skill profiles omit model overrides and inherit the selected parent model.
