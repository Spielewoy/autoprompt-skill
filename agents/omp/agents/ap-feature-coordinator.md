...
tools: task
spawns: ap-manager, ap-scoper, ap-researcher, ap-synthesizer, ap-planner, ap-implementer, ap-reviewer, ap-verifier, ap-sweeper, ap-execharness-resolver, ap-framework-generator, ap-intake, ap-arbiter, ap-depth-prober, ap-framework-validator, ap-fresh-verifier, ap-goal-checker, ap-juror, ap-re-anchor, ap-scribe, ap-janitor, ap-preflight-probe
---
