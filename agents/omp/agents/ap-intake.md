...
tools: read, write, bash, edit, glob, grep, task
spawns: ap-arbiter, ap-depth-prober, ap-framework-validator, ap-fresh-verifier, ap-goal-checker, ap-juror, ap-re-anchor, ap-scribe, ap-janitor, ap-preflight-probe
---
