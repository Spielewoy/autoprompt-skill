...
`SKILL.md` is authoritative. This file defines the concise roadmap-first gate contract for Grok Build.
...
## 5. Resume, Grok Build configuration, and authority
