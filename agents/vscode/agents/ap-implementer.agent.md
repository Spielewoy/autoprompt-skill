...
agents: ["ap-arbiter","ap-depth-prober","ap-framework-validator","ap-fresh-verifier","ap-goal-checker","ap-janitor","ap-juror","ap-preflight-probe","ap-re-anchor","ap-scribe"]
