...
### Hermes agent selection and effort

Hermes casting is `inherited-only`: native manual `runAs: subagent` skill profiles omit model overrides and inherit the selected parent model.
