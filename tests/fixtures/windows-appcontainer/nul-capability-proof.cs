...
public static class NulCapabilityProof {
 ...
 static UInt32 Access(IntPtr handle){IntPtr data=Marshal.AllocHGlobal(56);try{UInt32 needed;Need(NtQueryObject(handle,0,data,56,out needed)==0&&needed==56,"query-held-access");return unchecked((UInt32)Marshal.ReadInt32(data,4));}finally{Marshal.FreeHGlobal(data);}}
