...
public static class ResourceIdentityProof {
  ...
  public static bool Contracts(){Need(IntPtr.Size==8&&Marshal.SizeOf(typeof(STANDARD))==24&&Marshal.SizeOf(typeof(INFO))==52&&Marshal.SizeOf(typeof(ID_DESCRIPTOR))==24,"native-layout");Need(WindowsAppContainerResourcesNative.MaxResourceEntries==16384,"actual-resource-source");
