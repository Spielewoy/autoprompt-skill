...
const PUBLIC_PROVIDERS = ['claude', 'codex', 'opencode', 'kilo', 'vscode', 'prime', 'omp']
...
test('README is npm-first and public-release ready', () => {
  ...
  assert.match(readme, /href="https:\/\/github\.com\/Spielewoy\/autoprompt-skill\/releases\/latest"[^>]*>\s*<img[^>]+img\.shields\.io\/github\/v\/release\/Spielewoy\/autoprompt-skill[^>]+alt="Version 1\.0\.3"/)
